...
dd if=../rootfs-ubuntu-jammy/linaro-esp.img of=${BOOT} bs=4096 seek=256 conv=notrunc,fsync
dd if=../rootfs-ubuntu-jammy/linaro-rootfs.img of=${BOOT} bs=4096 seek=358656 conv=notrunc,fsync
