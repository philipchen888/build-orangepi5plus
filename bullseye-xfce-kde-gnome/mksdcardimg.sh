...
dd if=../rootfs-bullseye/linaro-esp.img of=${BOOT} bs=4096 seek=256 conv=notrunc,fsync
dd if=../rootfs-bullseye/linaro-basicrootfs.img of=${BOOT} bs=4096 seek=358656 conv=notrunc,fsync
